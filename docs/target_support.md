...
Target types sourced from CMSIS-Packs can define debug variables that the user can configure as needed. See the [debug variables documentation]({% link _docs/cmsis_pack_debug_descriptions.md %}#debug_variables) for details.
